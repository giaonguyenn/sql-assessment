...
CREATE TABLE IF NOT EXISTS vehicles (
  id serial,--(add datatype and/or table contraint),
  make varchar(255),--(add datatype and/or table contraint),
  model varchar(255),--(add datatype and/or table contraint),
